require([ "../lib/jquery-2.1.4",
  ...
  function() {
    ...
    var scriptUrl = (buildConfig.debug) ? "http://localhost/php/getPhotoList.php?directory=../images/gallery/interior"
      : "php/getPhotoList.php?directory=../images/gallery?directory=../images/gallery/interior";
    $.ajax({
      url: scriptUrl,
      success: function(response) {
        ...
        photoArray.forEach(function(fileName, index) {
          ...
          attr.value = 'images/gallery/interior/' + fileName;
          anchor.setAttributeNode(attr);
          attr = document.createAttribute('medium');
          attr.value = 'images/gallery/interior/medium/' + fileName;
          anchor.setAttributeNode(attr);
          ...
          attr.value = 'images/gallery/interior/thumb' + suffix + fileName;
