require([ "../lib/jquery-2.1.4",
  ...
  function() {
    ...
    var scriptUrl = (buildConfig.debug) ? "http://localhost/php/getPhotoList.php?directory=../images/gallery/events"
      : "php/getPhotoList.php?directory=../images/gallery?directory=../images/gallery/events";
    $.ajax({
      url: scriptUrl,
      success: function(response) {
        ...
        photoArray.forEach(function(fileName, index) {
          ...
          attr.value = 'images/gallery/events/' + fileName;
          anchor.setAttributeNode(attr);
          attr = document.createAttribute('medium');
          attr.value = 'images/gallery/events/medium/' + fileName;
          anchor.setAttributeNode(attr);
          ...
          attr.value = 'images/gallery/events/thumb' + suffix + fileName;
